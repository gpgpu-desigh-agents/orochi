...
#define DEPRECATED_MSG "This API is marked as deprecated and may not be supported in future releases. For more details please refer https://github.com/ROCm-Developer-Agents/HIP/blob/master/docs/markdown/hip_deprecated_api_list.md"
