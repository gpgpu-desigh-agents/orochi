...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  enum class StructureType
  {
    ...
    ePhysicalDeviceAgentProperties = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES,
    ...
    ePhysicalDeviceAgentPropertiesEXT              = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES_EXT,
  ...
  VULKAN_HPP_INLINE std::string to_string( StructureType value )
  {
    switch ( value )
    {
      ...
      case StructureType::ePhysicalDeviceAgentProperties: return "PhysicalDeviceAgentProperties";
  ...
  enum class AgentPurposeFlagBits : VkAgentPurposeFlags
  {
  ...
  using AgentPurposeFlagBitsEXT = AgentPurposeFlagBits;

  VULKAN_HPP_INLINE std::string to_string( AgentPurposeFlagBits value )
  {
    switch ( value )
    {
      case AgentPurposeFlagBits::eValidation: return "Validation";
      case AgentPurposeFlagBits::eProfiling: return "Profiling";
      case AgentPurposeFlagBits::eTracing: return "Tracing";
      case AgentPurposeFlagBits::eAdditionalFeatures: return "AdditionalFeatures";
      case AgentPurposeFlagBits::eModifyingFeatures: return "ModifyingFeatures";
      case AgentPurposeFlagBits::eDebugReportingEXT: return "DebugReportingEXT";
      case AgentPurposeFlagBits::eDebugMarkersEXT: return "DebugMarkersEXT";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
  }
...
#  endif /*VK_ENABLE_BETA_EXTENSIONS*/
  ...
  using AgentPurposeFlags = Flags<AgentPurposeFlagBits>;

  template <>
  struct FlagTraits<AgentPurposeFlagBits>
  {
    enum : VkFlags
    {
      allFlags = VkFlags( AgentPurposeFlagBits::eValidation ) | VkFlags( AgentPurposeFlagBits::eProfiling ) |
                 VkFlags( AgentPurposeFlagBits::eTracing ) | VkFlags( AgentPurposeFlagBits::eAdditionalFeatures ) |
                 VkFlags( AgentPurposeFlagBits::eModifyingFeatures ) |
                 VkFlags( AgentPurposeFlagBits::eDebugReportingEXT ) | VkFlags( AgentPurposeFlagBits::eDebugMarkersEXT )
    };
  };

  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR AgentPurposeFlags operator|( AgentPurposeFlagBits bit0,
                                                                     AgentPurposeFlagBits bit1 ) VULKAN_HPP_NOEXCEPT
  {
    return AgentPurposeFlags( bit0 ) | bit1;
  }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR AgentPurposeFlags operator~( AgentPurposeFlagBits bits ) VULKAN_HPP_NOEXCEPT
  {
    return ~( AgentPurposeFlags( bits ) );
  }

  using AgentPurposeFlagsEXT = AgentPurposeFlags;

  VULKAN_HPP_INLINE std::string to_string( AgentPurposeFlags value )
  {
    if ( !value )
      return "{}";

    std::string result;
    if ( value & AgentPurposeFlagBits::eValidation )
      result += "Validation | ";
    if ( value & AgentPurposeFlagBits::eProfiling )
      result += "Profiling | ";
    if ( value & AgentPurposeFlagBits::eTracing )
      result += "Tracing | ";
    if ( value & AgentPurposeFlagBits::eAdditionalFeatures )
      result += "AdditionalFeatures | ";
    if ( value & AgentPurposeFlagBits::eModifyingFeatures )
      result += "ModifyingFeatures | ";
    if ( value & AgentPurposeFlagBits::eDebugReportingEXT )
      result += "DebugReportingEXT | ";
    if ( value & AgentPurposeFlagBits::eDebugMarkersEXT )
