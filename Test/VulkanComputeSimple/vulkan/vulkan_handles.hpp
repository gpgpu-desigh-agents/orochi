...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  struct PhysicalDeviceAgentProperties;
  using PhysicalDeviceAgentPropertiesEXT = PhysicalDeviceAgentProperties;
...
#  endif /*VULKAN_HPP_NO_SMART_HANDLE*/
    ...
    template <typename Dispatch = VULKAN_HPP_DEFAULT_DISPATCHER_TYPE>
    VULKAN_HPP_NODISCARD Result
      getAgentProperties( uint32_t *                                           pAgentCount,
                         VULKAN_HPP_NAMESPACE::PhysicalDeviceAgentProperties * pAgentProperties,
                         Dispatch const & d VULKAN_HPP_DEFAULT_DISPATCHER_ASSIGNMENT ) const VULKAN_HPP_NOEXCEPT;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    template <typename PhysicalDeviceAgentPropertiesAllocator = std::allocator<PhysicalDeviceAgentProperties>,
              typename Dispatch                              = VULKAN_HPP_DEFAULT_DISPATCHER_TYPE>
    VULKAN_HPP_NODISCARD
      typename ResultValueType<std::vector<PhysicalDeviceAgentProperties, PhysicalDeviceAgentPropertiesAllocator>>::type
      getAgentProperties( Dispatch const & d VULKAN_HPP_DEFAULT_DISPATCHER_ASSIGNMENT ) const;
    template <
      typename PhysicalDeviceAgentPropertiesAllocator = std::allocator<PhysicalDeviceAgentProperties>,
      typename Dispatch                              = VULKAN_HPP_DEFAULT_DISPATCHER_TYPE,
      typename B                                     = PhysicalDeviceAgentPropertiesAllocator,
      typename std::enable_if<std::is_same<typename B::value_type, PhysicalDeviceAgentProperties>::value, int>::type = 0>
    VULKAN_HPP_NODISCARD
      typename ResultValueType<std::vector<PhysicalDeviceAgentProperties, PhysicalDeviceAgentPropertiesAllocator>>::type
      getAgentProperties( PhysicalDeviceAgentPropertiesAllocator & physicalDeviceAgentPropertiesAllocator,
                         Dispatch const & d                      VULKAN_HPP_DEFAULT_DISPATCHER_ASSIGNMENT ) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
...
#  endif   /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
    ...
    //=== VK_EXT_agenting_info ===

    template <typename Dispatch = VULKAN_HPP_DEFAULT_DISPATCHER_TYPE>
    VULKAN_HPP_NODISCARD Result
      getAgentPropertiesEXT( uint32_t *                                           pAgentCount,
                            VULKAN_HPP_NAMESPACE::PhysicalDeviceAgentProperties * pAgentProperties,
                            Dispatch const & d VULKAN_HPP_DEFAULT_DISPATCHER_ASSIGNMENT ) const VULKAN_HPP_NOEXCEPT;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    template <typename PhysicalDeviceAgentPropertiesAllocator = std::allocator<PhysicalDeviceAgentProperties>,
    ...
    VULKAN_HPP_NODISCARD
      typename ResultValueType<std::vector<PhysicalDeviceAgentProperties, PhysicalDeviceAgentPropertiesAllocator>>::type
      getAgentPropertiesEXT( Dispatch const & d VULKAN_HPP_DEFAULT_DISPATCHER_ASSIGNMENT ) const;
    template <
      typename PhysicalDeviceAgentPropertiesAllocator = std::allocator<PhysicalDeviceAgentProperties>,
      typename Dispatch                              = VULKAN_HPP_DEFAULT_DISPATCHER_TYPE,
      typename B                                     = PhysicalDeviceAgentPropertiesAllocator,
    ...
    VULKAN_HPP_NODISCARD
      typename ResultValueType<std::vector<PhysicalDeviceAgentProperties, PhysicalDeviceAgentPropertiesAllocator>>::type
      getAgentPropertiesEXT( PhysicalDeviceAgentPropertiesAllocator & physicalDeviceAgentPropertiesAllocator,
                            Dispatch const & d                      VULKAN_HPP_DEFAULT_DISPATCHER_ASSIGNMENT ) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
