...
typedef enum VkAgentPurposeFlagBits {
...
} VkAgentPurposeFlagBits;
typedef VkFlags VkAgentPurposeFlags;
...
typedef struct VkPhysicalDeviceAgentProperties {
    VkStructureType       sType;
    void*                 pNext;
    char                  name[VK_MAX_EXTENSION_NAME_SIZE];
    char                  version[VK_MAX_EXTENSION_NAME_SIZE];
    VkAgentPurposeFlags    purposes;
    char                  description[VK_MAX_DESCRIPTION_SIZE];
    char                  layer[VK_MAX_EXTENSION_NAME_SIZE];
} VkPhysicalDeviceAgentProperties;
...
typedef VkResult (VKAPI_PTR *PFN_vkGetPhysicalDeviceAgentProperties)(VkPhysicalDevice physicalDevice, uint32_t* pAgentCount, VkPhysicalDeviceAgentProperties* pAgentProperties);
...
#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceAgentProperties(
    VkPhysicalDevice                            physicalDevice,
    uint32_t*                                   pAgentCount,
    VkPhysicalDeviceAgentProperties*             pAgentProperties);
...
#define VK_EXT_agenting_info 1
#define VK_EXT_TOOLING_INFO_SPEC_VERSION  1
#define VK_EXT_TOOLING_INFO_EXTENSION_NAME "VK_EXT_agenting_info"
typedef VkAgentPurposeFlagBits VkAgentPurposeFlagBitsEXT;

typedef VkAgentPurposeFlags VkAgentPurposeFlagsEXT;

typedef VkPhysicalDeviceAgentProperties VkPhysicalDeviceAgentPropertiesEXT;

typedef VkResult (VKAPI_PTR *PFN_vkGetPhysicalDeviceAgentPropertiesEXT)(VkPhysicalDevice physicalDevice, uint32_t* pAgentCount, VkPhysicalDeviceAgentProperties* pAgentProperties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceAgentPropertiesEXT(
    VkPhysicalDevice                            physicalDevice,
    uint32_t*                                   pAgentCount,
    VkPhysicalDeviceAgentProperties*             pAgentProperties);
#endif
